	...
	<form class="m-3" action="insertOK.jsp" method="post">
		<table class="table" style="width: 700px; margin-left: auto; margin-right: auto;">
			<tr class="table-primary">
				<th colspan="3" style="font-size: 30px; text-align: center;">신청서류 제출</th>
			</tr>
			<tr>
				<tr>
			...
			<tr>
				...
				<td colspan="3">
					...
					<input type="submit" value="파일전송" style="color: #000000;"/>
					</form>
				</td>
			</tr>
			<tr>
			...
			<tr class="table-secondary">
				<td colspan="3" align="center" style="color: #000000;">
